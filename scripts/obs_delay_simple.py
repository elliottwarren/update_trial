...
# time and domain - fixed format
# time = 'START TIME YYYYMMDD/HHmmZ (Z is compulsory)
# Note: for those sub-types stored by the hour, such as satellite data, an END TIME of,
#      say 0200Z will return all data up to 0259Z. To obtain data up to 0200Z code END TIME as 0159Z.
start = 'START TIME 20191114/2100Z' # Start of assimilation window
end = 'END TIME 20191115/0259Z'   # End of assimilation window
area = 'AREA 90.00N 90.00S 180.00W 180.00E' # Area - global

keywords = [start, end, area]
# all possible elements listed in: https://metnet2.metoffice.gov.uk/content/metdb-subtypes-and-retrieval-details
...
contact = 'elliott.warren@metoffice.gov.uk'
subtype = 'LNDSYN' # synoptic land stations
timediffs = []
numReceivedInTime = 0

# Retrieve observations from MetDB (obs = 1D np.array, element=1D np.array, sub-element=item from [elements] variable)
